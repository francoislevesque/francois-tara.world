<template>
  <div class="w-full relative overflow-hidden">
    <img
      src="@/assets/Tara-Francois-37.jpg"
    ...
    <div class="relative pb-20 pt-80">
      <div class="text-center">
        <h1 class="font-display text-5xl mb-6 text-white">Tara & François</h1>

        <date
          class="mb-12 block font-serif font-light tracking-widest text-lg text-white"
        >
          06.09.2025
        </date>
  ...
  <div class="bg-[#e5e9e5]">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="flex gap-10 items-center flex-col || sm:flex-row">
          ...
          <div class="flex-1 text-center py-8 order-1 || sm:py-0 sm:order-2">
            <div
              class="text-[#324232] inline-block font-light leading-loose duration-300 font-serif max-w-xs"
            >
    ...
    <div class="sm:px-10">
      <div class="max-w-7xl mx-auto text-white">
        <div class="relative py-20 px-6">
          <img
            src="@/assets/Tara-Francois-101-3.jpg"
            alt="Francois and Tara"
            class="w-full h-full absolute inset-0 object-cover"
          />
          ...
          <div class="relative text-center">
            ...
            <h2 class="font-display text-5xl mb-16">
              {{ $t("we_hope_you_make_it") }}
            </h2>
            <Rsvp></Rsvp>
          </div>
        </div>
    ...
    <footer>
      <div class="flex max-w-7xl mx-auto py-16 font-display text-sm px-6">
        <div class="flex-1">
          <a href="mailto:tara.dignazio@gmail.com" class="underline">
            {{ $t("email_us") }}
          </a>
        </div>
        <div class="flex-1 text-right">Made with ❤️ by François Lévesque</div>
      </div>
    </footer>
  </div>
</template>
